...
export const StudentLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateEmailForRole(email, 'student')) {
      alert('Only student emails can login here. Use teacher or HOD login page.');
      setLoading(false);
      return;
    }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.formBox}>
        ...
        <p style={styles.subtitle}>Use your student email</p>
        ...
        <p style={styles.hint}>
          No account? <a href="/student/register" style={styles.link}>Register</a>
        </p>
