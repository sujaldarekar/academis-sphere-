...
export const TeacherLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateEmailForRole(email, 'teacher')) {
      alert('Only teacher emails can login here. Use student or HOD login page.');
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      console.log('[TeacherLoginPage] Login response:', {
        user: response.data.user,
        token: response.data.token ? 'token-received' : 'no-token'
      });
      console.log('[TeacherLoginPage] User role:', response.data.user.role);
  ...
  return (
    <div style={styles.container}>
      <div style={styles.formBox}>
        ...
        <p style={styles.subtitle}>Use your teacher email</p>
        ...
        <p style={styles.hint}>
          No account? <a href="/teacher/register" style={styles.link}>Register</a>
        </p>
        <p style={styles.linkRow}>
          <a href="/student/login" style={styles.link}>Student Login</a> |{' '}
          <a href="/hod/login" style={styles.link}>HOD Login</a>
        </p>
      </div>
    </div>
  );
